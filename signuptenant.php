...
if (isset($_POST['userName']) && isset($_POST['email']) && isset($_POST['password'])) 
{
    if (strlen($_POST['userName']) < 1 || strlen($_POST['email']) < 1 || strlen($_POST['password']) < 1 ) 
    {
        ...
        header("Location: signuptenant.php");
        return;
    } 
    ...
    try {
        ...
        $sql = "INSERT INTO users (userName, userType, userEmail, userPassword, userPreference)
                VALUES (?, ?, ?, ?, ?)";
        $stmt= $conn->prepare($sql);
        $stmt->execute([$user, $type, $email, $pass, $prefer]);
...
<html lang="en">
    <head>
        ...
        <title>Housing Mate | Signup as Tenant</title>
    </head>
    <body>
        ...
        <div class="container-fluid ">
            <div class ="card">
                <div class="container-fluid">
                    ...
                    <h6 class="text-muted">New to Housing Mate but not a Tenant, 
